...
ms.locfileid: "138051051"
---
# <a name="installation"></a>Installation
> `npm install --save @types/stoppable`

# <a name="summary"></a>Zusammenfassung
Dieses Paket enthält Typdefinitionen für stoppable (https://github.com/hunterloftis/stoppable).

# <a name="details"></a>Details
Dateien wurden aus https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/stoppable exportiert.
 ...
 * Letzte Aktualisierung: Mo, 31. Mai 2021 17:01:23 GMT
 * Abhängigkeiten: [@types/node](https://npmjs.com/package/@types/node)
 * Globale Werte: keine

# <a name="credits"></a>Mitwirkende
Diese Definitionen wurden von [Eric Byers](https://github.com/EricByers), [John Plusjé](https://github.com/jplusje) und [BendingBender](https://github.com/BendingBender) geschrieben.
